...
export default function LaudoLimpeza(){
 ...
 return <div className="report-wrap"><div className="report-actions no-print"><button className="secondary-button" onClick={()=>history.back()}>Voltar</button><button className="primary-button" onClick={()=>window.print()}>Imprimir / Salvar PDF</button></div><article className="report">
  ...
  <section><h2>Laudo de Limpeza e Higienização — Ar Condicionado</h2><p style={{lineHeight:1.65,textAlign:"justify"}}>Declaro que foram realizados os serviços de limpeza e higienização dos equipamentos de ar-condicionado relacionados neste laudo, com aplicação de bactericida/desinfetante à base de quaternário de amônio, composto por: Cloreto de Lauril-Miristil Dimetil Benzil Amônio 30%, acidulante, sequestrante, tensoativo não iônico e veículo, de acordo com as normas vigentes, conforme a Portaria nº 3.523, de 28/08/1998, do Ministério da Saúde.</p></section>
  ...
  <footer className="report-footer" style={{marginTop:60}}><div></div><div><span>Técnico responsável</span><strong>Raphael Boschi Modenez</strong><small>CPF: 314.531.618-48</small></div></footer>
