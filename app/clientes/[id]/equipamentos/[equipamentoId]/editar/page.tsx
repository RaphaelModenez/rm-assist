...
export default function EditarEq(){
 ...
 return <div className="page">
  <header className="simple-header"><div><p className="eyebrow">EQUIPAMENTO</p><h1>Editar equipamento</h1></div><Link href={`/clientes/${id}/equipamentos/${equipamentoId}/historico`} className="secondary-button">Histórico técnico</Link></header>
